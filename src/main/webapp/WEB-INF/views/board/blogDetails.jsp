...
<div class="my-details-middle">
	...
	<a class="my-writer" href="/${board.user.id}">${board.user.nickname}</a> · ${formattedDate}</div>
...
<div class="my-postInfo-bet">
	<div class="my-postInfo-top">
		<a href="/${board.user.id}" class="my-profile-left"><img src="/image/no_profile_img.jpg" alt="profile"></a>
		<div class="my-fc-w">
...
<form>
<input type="hidden" id="id" value="${board.user.id}">
...
<div class="my-reply-box my-fc-w my-box-underline">
	...
	<a class="my-fc-w" href="/${reply.user.id}"><img class="my-profile-img dropdown-toggle" src="/image/no_profile_img.jpg" />&ensp;${reply.user.nickname}</a>
